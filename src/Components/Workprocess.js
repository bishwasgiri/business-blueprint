...
const Workprocess = () => {
  return (
    <div className="mt-36 mx-auto w-full md:w-[70%] ">
      <Heading name="How it Works" />
      <div className="mt-20  flex flex-col items-center justify-center space-y-4 xl:space-y-0 xl:flex-row xl:items-stretch xl:justify-evenly xl:space-x-4 xl:bg-gray-100 p-3 xl:p-10 rounded-tl-[100px] rounded-br-[100px] shadow-md">
